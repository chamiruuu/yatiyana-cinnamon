...
!(function (n, t) {
  ...
  var kt = function (n) {
    ...
    jt = function (n, t) {
      (this.parent = this.parent || null),
        (this.selector = t),
        (this.anchor =
          U(n, "data-anchor") || Tt().anchors[A(n, Tt().sectionSelector)]),
        (this.item = n),
        (this.isVisible = d(n)),
      ...
      p(
        ...
        if (
          (["src", "srcset"].forEach(function (t) {
            ...
            null != e &&
              e &&
              (un(n, t), n.addEventListener("load", function () {}));
          }),
          Q(n, "source"))
        ) {
  ...
  function he() {
    var n =
      p(".fp-auto-height")[0] || (Pe() && p(".fp-auto-height-responsive")[0]);
    Tt().lazyLoading &&
      n &&
    ...
    (e = n),
      Tt().menu &&
        ...
        p(Tt().menu).forEach(function (n) {
          null != n &&
            (D(p(qn, n), Kn), L(p('[data-menuanchor="' + e + '"]', n), Kn));
        }),
      (function (n, t) {
        var e = p(Xn)[0];
        Tt().navigation &&
  ...
  function je(n, t, e) {
    ...
    if (null != i) {
      ...
      if (
        !(
          (pn().I.item == i && !dn.V) ||
          (Tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height"))
        )
      ) {
        if (
          (null != u.activeSlide &&
        ...
        function (n) {
          ...
          (He = t),
            Y(Tt().onScrollOverflow) &&
              Xt("onScrollOverflow", { position: t, direction: e }),
            m(n.target, at) &&
              dn.G &&
  ...
  function ki(n) {
    if (fe().m[n]) {
      ...
      Tt().scrollOverflow && Ve.yn(pn().I)
        ? Ve.isScrolled(n, pn().I.item) && Ve.Nn() && t()
        : t();
    }
  }
  var ji,
    ...
    Fi = 0,
    zi =
      (o.PointerEvent && (Di = { down: "pointerdown", move: "pointermove" }),
      Di),
    Ci = {
              ...
              if (l || (!t && u)) {
                ...
                var c = (function (n) {
                    var t,
                      ...
                      i = [],
                      o = Ft(
                        (dn.I && dn.I.activeSlide ? dn.I.activeSlide : dn.I)[
                          e
                        ]()
                      );
                    do {
                      (i = io(o.item)).length &&
                        (t = { Yn: o, $n: i[n ? i.length - 1 : 0] }),
                        (o = Ft(o[e]()));
                    } while (o && 0 === i.length);
                    return t;
                  })(l),
  ...
  function uo(n) {
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        new Date().getTime();
        var e =
            pn().B && n.getBoundingClientRect().bottom >= 0 && "up" === hi._n(),
          i = pn().Kn;
        if (i) return V(t), !1;
        if (pn().B) {
          if (e) {
            ...
            if (hi.Un())
              return (
                (e = !1), hn({ Kn: !0 }), hn({ N: "wheel" }), mi(), V(t), !1
              );
          } else Si("set", "beyondFullpage", 1e3);
          if (!i && !e) return !0;
        }
      })(St(), n);
    if ((dn.Z || hn({ J: !1, Z: !0, Y: "none" }), !fe().m.down && !fe().m.up))
      return V(n), !1;
    if (i) return !0;
    if (!1 === i) return V(n), !1;
            ...
            .forEach(function (n) {
              if (!e) {
                var t = Q(i, n),
                  o = C(i, n);
                (t || o) &&
                  (f.shared.Xn || fo(!1), (f.shared.Xn = !0), (e = !0));
              }
            }),
      ...
      (mo = setTimeout(function () {
        !(function () {
          if (
            ...
            (e = w()),
              (i = b()),
              (dn.en === e && yo === i) || (hn({ en: e }), (yo = i), Ao(!0));
          var e, i;
          hn({ V: !1 });
        })(),
          (So = !1);
  ...
  function zo(n) {
    ...
    if (
      ...
      pn().I &&
      (rn(pn().C),
      !pn().B && !pn().Kn && (!Tt().autoScrolling || Tt().scrollBar))
    ) {
      var a = H(),
        u = (function (n) {
          var t = n > Fo ? "down" : "up";
        ...
        : (Tt().continuousVertical &&
          ...
          Tt().anchors.forEach(function (n) {
            var t = [].slice.call(p("[name]")).filter(function (t) {
                return (
                  U(t, "name") && U(t, "name").toLowerCase() == n.toLowerCase()
                );
              }),
              e = [].slice.call(p("[id]")).filter(function (t) {
                return (
                  U(t, "id") && U(t, "id").toLowerCase() == n.toLowerCase()
                );
              });
      ...
      return (
        ...
        (f.test = Object.assign(f.test, {
          ...
          Hn: (function () {
            for (
              var n = [], t = 0;
              t < p(Tt().sectionSelector, St()).length;
              t++
            )
